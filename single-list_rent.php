				...
				<div class="col-12">
					<div class="site-navbar">
						...
						<?php 
                            ...
                            if($_SESSION['type']=='builder')
                            {
                                echo "<li><a href='builderHome.php'>Need Today</a></li>";
                            }
                            else
                            {
                                echo "<li><a href='normalHomeSale.php'>Need Today</a></li>";
                            }
                            ?>
							
             				  <?php if($_SESSION['type']=='builder')
                            {
                                echo "<li><a href='builderHome.php'>Need Daily</a></li>";
                            }
                            else
                            {
                                echo "<li><a href='normalHomeSale.php'>Need Daily</a></li>";
                            }
                            ?>
	...
	<section class="page-section">
		<div class="container">
          ...
          <div class="single-list-content">
						...
						<h3 class="sl-sp-title">Product Details</h3>
						...
						<h3 class="sl-sp-title">Product Size</h3>
						<div class="row property-details-list">
							<div class="col-md-12 col-sm-6">
								<p><i class="fa fa-check-circle-o"></i><?php echo $row['amenities'] ?></p>
							</div>
						</div>
						<h3 class="sl-sp-title bd-no">Rateplan</h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6 footer-widget">
					...
					<p>We Provide You the basic Rates Of the vegetables of the todays Market and this will be Very Usefull For You To Sell Your Products.</p>
					<div class="social">
						<a href="#"><i class="fa fa-facebook"></i></a>
						<a href="#"><i class="fa fa-twitter"></i></a>
						<a href="#"><i class="fa fa-instagram"></i></a>
				...
				<div class="col-lg-3 col-md-6 footer-widget">
					<div class="contact-widget">
						...
						<p><i class="fa fa-envelope"></i>info.Ulzhavar-Koodam.com</p>
