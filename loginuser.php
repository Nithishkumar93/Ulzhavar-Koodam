			...
			<div class="container">
					...
					<div class="col-lg-6 text-lg-right header-top-right">
						...
						<div class="user-panel">
							<a href="register.php"><i class="fa fa-user-circle-o"></i>Farmer</a>
							<a href="reg_builder.php"><i class="fa fa-user-circle-o"></i>Shop Keeper</a>
...
<tr>
	...
	<select name="type">
					...
					<option value="normal" selected>Farmer</option>
				    <option value="builder" >Shop Keeper</option>
