...
<body>
					...
					<div class="site-navbar">
						...
						<ul class="main-menu">
                            ...
                            ?>
								  <?php if($_SESSION['type']=='builder')
                            {
                                echo "<li><a href='builderHome.php'>Upcoming Need</a></li>";
                            }
                            else
                            {
                                echo "<li><a href='normalHomeSale.php'>Upcoming Need</a></li>";
                            }
                            ?>
							
          
			  <li><a href="upcomingprojects.php">Upcoming Product Needs</a></li>
	...
	<section class="page-top-section set-bg" data-setbg="img/b23.jpg">
		<div class="container text-white">
			<h2>Packers And Movers at your Door Step</h2>
		</div>
	</section>
	<!--  Page top end -->
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span><i class="fa fa-angle-right"></i>Packers And Movers at your Door Step</span>
		</div>
	</div>
